...
<div class="container">
	...
	<center>
      ...
      <b style="color:#808080">/Report</b>
		<b style="color:#808080">/Transaction Report by Month</b>
	</center>
	<br>
	<div class="row">
		<div class="col-lg-12 col-md-12">
			<div class="tabs-container">
				<ul class="nav nav-tabs">
					<li class="active"><a data-toggle="tab" href="#deposit"> Transaction Report by Month</a></li>
							...
							<div class="row">
								<div class="col-md-6 col-lg-6">
   								 <label for="formGroupExampleInput">Search :</label>
									 <form class="" action="{{route('transaction/reportByMonth')}}" method="get">
